---
title: "Software Just Entered Its Third Era (Loop-Native Era of Software). The Job That Runs It Pays $190K and Almost Nobody's Talking About It."
excerpt: "AI didn't remove the need for engineers — it moved where they're needed. Inside the rise of the Forward Deployed Engineer, and why the biggest tech companies just bet billions on it."
date: "2026-07-21"
readTime: "9 min read"
...
- $3.5B — committed by AWS and Microsoft to Forward Deployed Engineering, in a single week this June
- 729% — growth in FDE job postings over one year (Indeed data)
- $190K — median FDE pay, onsite and remote combined
- 100 vs. 2,500 — the size of team now expected to do the work that used to take a small army
