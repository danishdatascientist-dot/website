...
const videos = [
  { title: "NVIDIA RTX Spark & The SaaSpocalypse: How AI Agents are Replacing Apps", duration: "6:57", views: "7 views", published: "3 weeks ago" },
  { title: "LinkedIn Creator Agent 🚀 | AI-Powered LinkedIn Content Generator with FastAPI & Gemini AI", duration: "3:55", views: "13 views", published: "4 weeks ago" },
  { title: "CareerPilot AI | AI Resume Analyzer, Job Matcher & Career Coach using FastAPI + Gemini", duration: "1:49", views: "14 views", published: "4 weeks ago" },
  { title: "AI-powered Gold & Silver Investment Intelligence", duration: "1:20", views: "8 views", published: "5 months ago" },
  ...
  { title: "AI Travel Planner with FastAPI + LangGraph – Plan Trips in Seconds!", duration: "1:58", views: "212 views", published: "1 year ago", url: "https://youtu.be/xVgsMu_pdRY?si=5dkoUksPiPWkfZgu" },
  { title: "AI E-Commerce Chatbot | FastAPI + Google Gemini + AstraDB Vector Store | Real Project Demo (2025)", duration: "2:27", views: "173 views", published: "1 year ago" },
  { title: "Build a Multi-PDF Chatbot with LangChain + Gemini AI + FAISS | Ask PDFs Anything!", duration: "2:05", views: "241 views", published: "1 year ago", url: "https://youtu.be/Nl3vSJcA0Ls?si=NnXmu9aYET2AndNf" },
  { title: "AI-Powered Portfolio Website with Chatbot | Built by Danish Shahzad Using Pinecone Vector Database", duration: "0:49", views: "81 views", published: "1 year ago" },
  { title: "AI-Powered Blog Post Generator | Create Professional Blogs in Seconds | Best Blogging Tool 2024", duration: "1:55", views: "74 views", published: "1 year ago" },
  { title: "AI Chatbot for PDFs, ArXiv, YouTube, Text, and CSV Files | Interactive Q&A with Your Data", duration: "4:57", views: "112 views", published: "1 year ago" },
];
