...
export const metadata: Metadata = {
  title: "1:1 AI Consultation — 30–60 Min Expert Session",
...
export default function ConsultationPage() {
  return <main className="bg-white dark:bg-gray-900">
    <JsonLd data={serviceSchema({ name: "AI and Data Science Consultation", path: "/services/consultation", description: metadata.description as string, audience: "Individuals, founders, professionals, small businesses, and project builders" })} />
    <JsonLd data={breadcrumbSchema([{ name: "Home", path: "" }, { name: "Services", path: "/services" }, { name: "AI Consultation" }])} />
